...
let g:dracula#palette.bglighter = ['#191A21', 238]
let g:dracula#palette.bglight   = ['#191A21', 237]
let g:dracula#palette.bg        = ['#191A21', 236]
let g:dracula#palette.bgdark    = ['#191A21', 235]
